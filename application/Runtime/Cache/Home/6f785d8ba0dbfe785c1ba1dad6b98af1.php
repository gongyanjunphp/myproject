		...
		<div class="act_content">
			...
			<!--文章列表-->
				<ul class="list_img list_img_main">
					<?php if(is_array($facility_list)): foreach($facility_list as $key=>$v): ?><li><a href="<?php echo U('details', 'id='.$v[id]);?>" class="a_img"><img src="<?php echo (ltrim($v["picpath"],'.')); ?>"</a><a href="#" class="a_txt"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
				</ul>
