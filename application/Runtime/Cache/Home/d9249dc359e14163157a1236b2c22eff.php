...
<div class="main">
	...
	<div class="act_mrr">
		...
		<div class="act_content">
			<!--当前位置-->
			<div class="weizhi"><span>当前位置： <a href="#">首页</a> &gt;  <a class=" &gt; " href="#">关于我们</a> &gt;&gt; <a class=" &gt; " href="#">塑料袋小常识</a></span></div>
			<!--标题-->
			<div class="content_p">
				<h1><?php echo ($info["title"]); ?></h1>
				<div style="text-align: center">发表时间:<h5><?php echo ($info["createtime"]); ?></h5></div>
				<!--单页内容-->
				<div class="act_neirong"><img src="<?php echo (ltrim($info["picpath"],'.')); ?>">
				</div>
			</div>
			<!--//content_p-->
			<!--收藏按钮-->
