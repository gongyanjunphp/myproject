...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	<title>联系我们_忻州左所塑料袋厂</title>
	<meta name="description" content="<?php echo ($ArticleIntro); ?>">
	<meta name="keywords" content="<?php echo ($ArticleKeyWord); ?>">
...
<div class="main">
	...
	<div class="act_mr">
		...
		<div class="act_content">
			<!--当前位置-->
			<div class="weizhi"><span>当前位置： <a href="#">首页</a> &gt;  <a class=" &gt; " href="#">关于我们</a> &gt;&gt; <a class=" &gt; " href="#">企业概况</a></span></div>
			<!--标题-->
			<div class="content_p">
				<h1>联系我们</h1>
				<!--单页内容-->
				<div class="act_neirong">
					<p><strong>单位</strong>：<?php echo ($info["company"]); ?></p>
					<p><strong>地址</strong>：<?php echo ($info["address"]); ?></p>
					<p><strong>邮编</strong>：<?php echo ($info["postalcode"]); ?> </p>
					<p><strong>电话</strong>：<?php echo ($info["telephone"]); ?></p>
					<p><strong>Email</strong>: <?php echo ($info["email"]); ?></p>
					<iframe width="1150px" height="650px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://j.map.baidu.com/s/33A_Fb"></iframe>				</div>
			</div>
			<!--//content_p-->
			<!--收藏按钮-->
	...
	<div class="act_ml">
		...
		<div class="hot">
			...
			<div class="hot_nr">
				<ul>
					<span><a href="<?php echo U('Home/Company/Index');?>">联系我们</a></span><span><a href="<?php echo U('Home/Honor/Index');?>">资质荣誉</a></span><span><a href="<?php echo U('Home/Facility/Index');?>">设备工艺</a></span><span><a href="<?php echo U('Home/Live/Index');?>">生活场景</a></span><span><a href="<?php echo U('Home/Contactus/Index');?>">联系我们</a></span>
				</ul>
			</div>
		</div>
		<!--最新文章-->
