            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Facility/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        ...
                        <?php if(is_array($facility_list)): foreach($facility_list as $key=>$v): ?><tr>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Facility/dels/id/" + ids;
    })
</script>
</html>