    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">塑料袋价格</span>
            </div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Price/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        ...
                        <?php if(is_array($price_list)): foreach($price_list as $key=>$v): ?><tr>

                            <td class="tc" align="center">
                                <input name="id[]" value=<?php echo ($v["id"]); ?> type="checkbox">
                            </td>
                            <td  align="center"><?php echo (substr($v["title"],0,120)); ?></td>
                            <td  align="center"><?php echo (substr($v["content"],0,300)); ?></td>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Price/dels/id/" + ids;
    })
</script>
</html>