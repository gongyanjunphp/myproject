            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Comprofile/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        <tr>
                            ...
                            <th style="text-align:center" width="30%">企业概况</th>
                        ...
                        <?php if(is_array($company_list)): foreach($company_list as $key=>$v): ?><tr>

                            <td class="tc" align="center">
                                <input name="id[]" value=<?php echo ($v["id"]); ?> type="checkbox">
                            </td>
                            <td  align="center"><?php echo (mb_substr($v["content"],0,260)); ?>...</td>
                            <td  align="center"><img src="<?php echo (ltrim($v["illustration"],'.')); ?>" style="width: 90px; height: 40px"></td>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Comprofile/dels/id/" + ids;
    })
</script>
</html>