    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">产品介绍</span>
            </div>
        </div>
            ...
            <div class="search-content">
                <form action="<?php echo U('index');?>" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">产品名称:</th>
                            <td><input class="common-text" placeholder="请输入产品名称" name="keywords" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Goods/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        <tr>
                            ...
                            <th style="text-align:center" width="10%">产品名称</th>
                        ...
                        <?php if(is_array($goods_list)): foreach($goods_list as $key=>$v): ?><tr>
                            ...
                            <td  align="center"><img src="<?php echo (ltrim($v["picpath"],'.')); ?>" style="width: 90px; height: 40px"></td>
                            <td  align="center"><?php echo ($v["createtime"]); ?></td>
                            <?php if($v["status"] == 1): ?><td  align="center">开启</td>
                            <?php else: ?>
                            <td  align="center">关闭</td><?php endif; ?>
                            <td  align="center">
                                <a class="link-update" href="<?php echo U('Admin/Goods/edit', 'id='.$v[id]);?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/Goods/del', 'id='.$v[id]);?>">删除</a>
                            </td>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Goods/dels/id/" + ids;
    })
</script>
</html>