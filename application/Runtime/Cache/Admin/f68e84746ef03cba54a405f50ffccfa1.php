    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">通知中心</span>
            </div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Notice/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        ...
                        <?php if(is_array($notice_list)): foreach($notice_list as $key=>$v): ?><tr>

                            <td class="tc" align="center">
                                <input name="id[]" value=<?php echo ($v["id"]); ?> type="checkbox">
                            </td>
                            <td  align="center" width="100px" ><?php echo ($v["title"]); ?></td>
                            <td  align="center"><?php echo (substr($v["content"],0,240)); ?></td>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Notice/dels/id/" + ids;
    })
</script>
</html>