    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">塑料袋小知识</span>
            </div>
        </div>
            ...
            <div class="search-content">
                <form action="<?php echo U('index');?>" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">标题:</th>
                            <td><input class="common-text" placeholder="请输入标题" name="keywords" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Knowledge/add');?>"><i class="icon-font"></i>添加</a>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Knowledge/dels/id/" + ids;
    })
</script>
</html>