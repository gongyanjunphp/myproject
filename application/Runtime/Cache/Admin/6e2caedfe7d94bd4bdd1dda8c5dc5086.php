    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-name">资质荣誉</span>
            </div>
        </div>
            ...
            <div class="search-content">
                <form action="<?php echo U('index');?>" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">资质荣誉:</th>
                            <td><input class="common-text" placeholder="请输入资质荣誉名称" name="keywords" value="" id="" type="text"></td>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/Honor/add');?>"><i class="icon-font"></i>添加</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%" align="center">
                        <tr>
                            ...
                            <th style="text-align:center" width="10%">资质荣誉</th>
                        ...
                        <?php if(is_array($honor_list)): foreach($honor_list as $key=>$v): ?><tr>
...
<script>
    ...
    $('.del').click(function(){
        ...
        location.href = "/index.php/Admin/Honor/dels/id/" + ids;
    })
</script>
</html>